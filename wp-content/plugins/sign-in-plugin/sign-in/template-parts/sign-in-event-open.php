            <div class="main-content">
                ...
                <div class="button-container d-md-flex mt-3 pause-container">
                    <div class="my-4 me-3">Check in URL: <a href="<?php echo wp_logout_url( esc_url( get_site_url(null, 'sign-in-event-start-registration/?event=' . get_the_title() ) ) ); ?>"><?php echo get_site_url(null, 'sign-in-event-start-registration/?event=' . get_the_title()); ?></a></div>
                    <form class="pause-check-in">
                        <input type="hidden" name="id" value="<?php echo $event_id; ?>" />
                        <input type="hidden" name="action" value="pause_check_in">
                        <?php wp_nonce_field('pause_check_in', 'pause_check_in_nonce'); ?>
                        <input type="submit" class="btn btn-primary btn-medium" value="Pause Check In">
                    </form>
                </div>
                ...
                <div class="row mt-3 two-columns">
                    ...
                    <div class="col-12 col-md-6 text-center mb-3">
                        ...
                        <div class="fw-bold mt-3">
                            ...
                            <a href="#" style="display:none;">Download as Word doc</a>
                        </div>
                    </div>
                </div>
                <h1>Summary</h1>
                ...
                <div class="row mt-3 text-center ">
                    <form id="close-event">
                        <input type="hidden" name="id" value="<?php echo $event_id; ?>" />
                        <input type="hidden" name="action" value="close_sign_in_event">
                        <?php 
                        wp_nonce_field('close_sign_in_event', 'close_sign_in_event_nonce'); 

                        if (get_option('concur_active', false)) :?>
                        <input type="text" name="concur_note" class="form-control" placeholder="Add note to report.">
                        <?php endif; ?>
                        <input type="submit" name="submit-close-event" value="Close Event & Send Reports" class="btn btn-tertiary btn-medium mt-3" />
                    </form>
                </div>
            </div>
